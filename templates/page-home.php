<?php /* Template Name: Home Page */ if(have_posts()): while(have_posts()): the_post(); get_header(); ?>
	...
	<html lang="en" dir="ltr">
		...
		<body>
			<?php
			$myQuery = new WP_Query(array('post_type' => 'facts', 'posts_per_page' => '-1', 'category_name' => 'uncategorized' ,'order' => 'ASC', 'orderby' => 'title'));
			if($myQuery->have_posts()):
				echo '<div class="types">';
				while($myQuery->have_posts()):
					$myQuery->the_post();
					$pageTitle = $post->post_title;
					$pageLink = '/fact/?type='. $post->post_name;
					$image = get_field('fact_image'); ?>
					<div class="type">
						<?php echo $pageLink ? '<a href="'. $pageLink .'">' : '';
